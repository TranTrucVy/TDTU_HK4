      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <h1 class="my-4" style="font-size: 35px">Samsung</h1>
          ...
          <div class="col-lg-9">
            ...
            <div class="row">
            <?php
              $sql_phone = "SELECT * FROM `product` WHERE `name` LIKE '%Samsung%'";
              ...
              while($row = $run->fetch_array(MYSQLI_ASSOC)){
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card h-100" >
                    <a href="product_detail.php?id='.$id.'"><img style="padding:10px" class="card-img-top" src="'.$image.'" alt=""></a>
                    <div class="card-body">
                      <h4 class="card-title">
                        <a href="product_detail.php?id='.$id.'">'.$name.'</a>
                      </h4>
